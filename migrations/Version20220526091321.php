 ...
 */
final class Version20220526091321 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE parametre (id_parametre INT UNSIGNED AUTO_INCREMENT NOT NULL, nom_parametre VARCHAR(254) NOT NULL, description_parametre LONGTEXT NOT NULL, PRIMARY KEY(id_parametre)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parametre_valeur (id_valeur_parametre INT UNSIGNED AUTO_INCREMENT NOT NULL, id_parametre INT UNSIGNED DEFAULT NULL, code_valeur VARCHAR(32) NOT NULL, valeur LONGTEXT NOT NULL, valeur2 INT DEFAULT NULL, description_valeur LONGTEXT DEFAULT NULL, INDEX IDX_41E5D02A2CF22C66 (id_parametre), PRIMARY KEY(id_valeur_parametre)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE parametre_valeur ADD CONSTRAINT FK_41E5D02A2CF22C66 FOREIGN KEY (id_parametre) REFERENCES parametre (id_parametre)');
